    ...
    <div class="container">
        ...
        <div class="table-responsive inner-bottom-xs inner-top-xs">
            ...
            <table class="table table-bordered table-striped compare-list">
                ...
                <tr class="comparison-item">
                    <th>Water resistance (FK or -)</th>
                    <% int counterResistance = 0; %>
                    <c:forEach items="${tableCompare}" var="list_water_resistance" varStatus="counterResistance">
                        <td class="odd " id="waterResistance<%=counterResistance%>"><span class="amount">
                                                            <c:choose>
