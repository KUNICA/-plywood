...
<div>
    ...
    <c:forEach items="${listOffer}" var="list_object" varStatus="counter">
        ...
        <tr>
            <th>
                amount: ${list_object.count} price: ${list_object.product.price}
            </th>
        </tr>
    </c:forEach>
        <tr>
        ...
        <tr>
            <button type="button" id="removeOffer" class="btn btn-success" style="margin-left: auto; margin-right: auto;">complete</button>
        </tr>
    </table>
</div>